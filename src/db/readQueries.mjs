...
readQueries.getInstEmployee = () => {
  return `select case when dm.class='A' THEN 1 WHEN dm.class='C' OR dm.class='D' THEN 2 end  as tech_type ,emp.employee_type,emp.sevarth_no,emp.id,emp.title,emp.full_name,dm.designation_name,
