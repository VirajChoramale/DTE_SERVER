...
import { personalDetailsData, fetchExperianceFormData, fetchEducationFormData, employeeExperiance, fetchEmployeeCertificate, getEmployeePersonalDetails, getMaritialDetails, getEmployeeEducation, getOtherDestils, fetchMaritalStatusFormData, getEmployeeSpacialPromotion, getEmployeeFormStatus, getEmployeeCertificates } from "../controllers/DataStreamPipeline.mjs";
router.post("/personalDetailsData", personalDetailsData, (req, res) => {});
router.post("/fetchEducationFormData", fetchEducationFormData, (req, res) => {});
router.post("/fetchMaritalStatusFormData", fetchMaritalStatusFormData, (req, res) => {});
router.post("/fetchExperianceFormData", fetchExperianceFormData, (req, res) => {});
